...
Run with:
    ...
    python -m pytest LookingGlass/control_podium/tests/test_comms_e2e_sim.py -v --noconftest -s
"""
...
async def test_compact_status_rep_fits_in_ble_mtu(
    ...
    try:
        ...
        from comms.secure import Codec, DEFAULT_SECRET_PATH, load_secret
        codec = Codec(key=load_secret(DEFAULT_SECRET_PATH))
        wire = codec.encode(
            Frame(
