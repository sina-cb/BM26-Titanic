// BLE GATT layout — mirrors LookingGlass/control_podium/firmware/src/titanic_ble.h.
// Each Heltec running podium_tx / server_rx exposes this same service.
// They advertise as `tcon_<node-name>` (e.g. `tcon_captain`, `tcon_server`);
...
// comes from the `name:` field in `LookingGlass/control_podium/.config.nodes.yaml`.
...
//
//   * captain (`tcon_captain`, `tcon_captain_02`, …) — normal range-test path:
