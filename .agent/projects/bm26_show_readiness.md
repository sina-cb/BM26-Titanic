...
- Playlists: engine `config.yaml playlist:`, per-channel playlists in
  mixer/deck state, CaptainPad deck playlist UI (see July 9 plan Track B —
  `party_high`/`party_low`/`ambient` concept).
...
- Thread tracker: `../memory/bm_readiness_thread_tracker.md`
- Sub-projects: `bm_readiness_mapping.md`, `autopilot_profiles_audio_reactive.md`,
  `deck_split_playlists.md`, `effect_tuning.md`
- Plans: `../plans/20260709_party_readiness_execution.md` (party-night
  precursor; playlist track is the seed of R2/R3)
