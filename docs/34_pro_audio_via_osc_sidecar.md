...
**Related docs:** `36_marsin_audio_framework.md` (the first-party Companion realizes this same OSC-in pattern) · `24_osc_integration.md` (OSC adapter) · `25_marsin_audio_analysis.md` (in-engine analyzer) · `29_node_based_audio_post_processing.md` (chain framework) · `15_central_param_center_cpc.md` (CPC)
