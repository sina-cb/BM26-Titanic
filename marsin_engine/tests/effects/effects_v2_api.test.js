...
const h = createEngineHarness({
  ...
  portBase: 7100,
  portSpan: 300,
  // Force VSN1 layout-deploy OFF for this suite regardless of the committed
  // config.yaml value — the deploy-status assertions below rely on it staying
  // 'disabled', and the suite must NEVER spawn the deploy child (no COM12 /
  // hardware in a unit test).
