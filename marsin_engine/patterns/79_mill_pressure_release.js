...
export var pressure = 0.4;
export var heatBloom = 0.5;
export var ventFlash = 0.25;
export var coolingAfterglow = 1.0;
...
export function render3D(index, x, y, z) {
  var phase = (tPhase * pressure * 5.0) % 1.0;
  if (phase < 0) phase += 1.0;
  var heat = phase * heatBloom;
  var r = (pr1 + (pr2 - pr1) * heat) * heat;
  var g = (pg1 + (pg2 - pg1) * heat) * heat;
  var b = (pb1 + (pb2 - pb1) * heat) * heat;
  var w = (phase > 0.95) ? ventFlash : 0.0;
  var a = ((viewMask & 2) != 0) ? heat : 0.0;
  var u = (phase < 0.3) ? (coolingAfterglow * (1.0 - phase / 0.3)) : 0.0;
