...
export function render3D(index, x, y, z) {
  var sweepPos = wave(tPhase);
  var sweep = abs(x - sweepPos) < sweepWidth ? 1.0 : 0.0;
  var r = pr1 * sweep * 0.5;
  var g = pg1 * sweep * 0.5;
  var b = pb1 * sweep * 0.5;
  var w = sweep * sweepImpact;
  var a = 0.0;
  var u = edgeTrail * (1.0 - sweep);
