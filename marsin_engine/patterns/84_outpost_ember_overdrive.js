...
export var emberSpeed = 0.5;
export var emberHeight = 0.65;
...
export function sliderEmberHeight(v) { emberHeight = v; }
...
export function render3D(index, x, y, z) {
  var flame = wave(y * emberHeight - tPhase * emberSpeed * 2.0);
  var r = flame;
  var g = flame * 0.35;
  var b = 0.0;
