...
export var abyssalDarkness = 0.6;
...
export function render3D(index, x, y, z) {
  ...
  var w = isApex ? (pulse * signalStrength) : 0.0;
  var a = ((viewMask & 8) != 0) ? (responseGlow * wave(tPhase * 3.0)) : 0.0;
  var r = pr1 * abyssalDarkness * 0.2;
  var g = pg1 * abyssalDarkness * 0.2;
  var b = pb1 * abyssalDarkness * 0.2;
  var u = (isApex ? 1.0 : 0.8) * uvIntensity;
