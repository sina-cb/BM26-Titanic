/*
  redwood_shadow_breath
  Pattern matching technical and artistic specifications.
*/

export var localSpeed = 0.5;
export var shadowDepth = 1.0;
export var canopySwell = 0.4;
...
export function sliderCanopySwell(v) { canopySwell = v; }
...
export function render3D(index, x, y, z) {
  var breath = wave(tPhase);
  var isRedwood = (viewMask & 64) != 0;
  var isTower = (viewMask & 1) != 0;
  var r = 0.0, g = 0.0, b = 0.0, u = 0.0;
  if (isRedwood || isTower) {
    r = pr1 * canopySwell * breath;
    g = pg1 * canopySwell * breath;
    b = pb1 * canopySwell * breath;
    u = shadowDepth * (1.0 - breath);
  }
