...
// Helper function to translate HSV to RGB
function _hsv2rgb1() {
...
export function render3D(index, x, y, z) {
  var angle = atan2(z - 0.5, x - 0.5);
  var sweep = wave((angle / PI2) + tPhase * vortexSpeed);
  var core = sweep > 0.95 ? 1.0 : 0.0;
  var r = (pr1 + (pr2 - pr1) * sweep) * 0.6;
  var g = (pg1 + (pg2 - pg1) * sweep) * 0.6;
  var b = (pb1 + (pb2 - pb1) * sweep) * 0.6;
  var w = core * sweepImpact;
  var a = ((viewMask & 2) != 0) ? outpostGlow : 0.0;
  var u = core * uvIntensity;
