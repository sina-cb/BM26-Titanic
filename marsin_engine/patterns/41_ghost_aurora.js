...
export var auroraDepth = 0.5;
export var rimShimmer = 0.25;
export var humanWarmth = 0.3;
...
export function render3D(index, x, y, z) {
  ...
  var r = (pr1 + (pr2 - pr1) * noise) * auroraDepth;
  var g = (pg1 + (pg2 - pg1) * noise) * auroraDepth;
  var b = (pb1 + (pb2 - pb1) * noise) * auroraDepth;
  var w = rimShimmer * wave(x * 10.0 + tPhase * 3.0) * (random(1) < 0.2 ? 1.0 : 0.0);
  var a = ((viewMask & 8) != 0) ? humanWarmth : 0.0;
