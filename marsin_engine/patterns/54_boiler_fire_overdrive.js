...
export var fireSpeed = 0.5;
export var flameHeight = 0.65;
export var heatFlash = 0.3;
...
export function sliderFireSpeed(v) { fireSpeed = v; }
export function sliderFlameHeight(v) { flameHeight = v; }
export function sliderHeatFlash(v) { heatFlash = v; }
...
export function render3D(index, x, y, z) {
  var flame = wave(y * flameHeight - tPhase * fireSpeed * 2.0);
  var r = flame;
  var g = flame * 0.3;
  var b = 0.0;
  var w = (random(1) < 0.1 * heatFlash) ? 1.0 : 0.0;
  var a = flame * 0.7;
  var u = (1.0 - flame) * uvIntensity;
