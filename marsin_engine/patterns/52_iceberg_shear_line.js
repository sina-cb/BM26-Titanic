...
export var shearSharpness = 0.55;
export var shearDepth = 0.45;
...
export function sliderShearSharpness(v) { shearSharpness = v; }
export function sliderShearDepth(v) { shearDepth = v; }
...
export function render3D(index, x, y, z) {
  ...
  var edge = abs(line) < 0.05 ? 1.0 : 0.0;
  var side = line > 0.0 ? 1.0 : 0.0;
  var r = mix(pr1, pr2, side) * shearDepth;
  var g = mix(pg1, pg2, side) * shearDepth;
  var b = mix(pb1, pb2, side) * shearDepth;
  var w = edge * shearSharpness;
  var a = 0.0;
