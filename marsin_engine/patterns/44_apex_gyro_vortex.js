...
export function render3D(index, x, y, z) {
  ...
  var core = sweep > 0.9 ? 1.0 : 0.0;
  var r = (pr1 + (pr2 - pr1) * sweep) * hullGlow;
  var g = (pg1 + (pg2 - pg1) * sweep) * hullGlow;
  var b = (pb1 + (pb2 - pb1) * sweep) * hullGlow;
  var w = core * sweepImpact;
  var a = ((viewMask & 8) != 0) ? hullGlow : 0.0;
  var u = (1.0 - sweep) * uvIntensity;
